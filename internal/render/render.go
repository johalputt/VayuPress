...
<nav class="site-nav" aria-label="Primary">
  <a href="/" class="site-nav-brand"><span class="site-nav-brand-icon">Ω</span>VayuPress</a>
...
<footer><div class="footer-brand"><span class="site-nav-brand-icon">Ω</span>VayuPress</div><span class="footer-badge">runtime · governed</span></footer>
</div></body></html>`))
