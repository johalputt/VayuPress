...
const schema = `CREATE TABLE vayuanalytics_sessions(id INTEGER PRIMARY KEY AUTOINCREMENT,session_hash TEXT NOT NULL,visitor_hash TEXT NOT NULL DEFAULT '',page_path TEXT NOT NULL,source_category TEXT NOT NULL DEFAULT 'direct',source_detail TEXT NOT NULL DEFAULT '',referrer_domain TEXT NOT NULL DEFAULT '',referrer_path TEXT NOT NULL DEFAULT '',entry_time DATETIME NOT NULL,exit_time DATETIME,time_on_page_seconds INTEGER NOT NULL DEFAULT 0,scroll_depth_percent INTEGER NOT NULL DEFAULT 0,engaged INTEGER NOT NULL DEFAULT 0,bounce INTEGER NOT NULL DEFAULT 0,interaction_count INTEGER NOT NULL DEFAULT 0,country_code TEXT NOT NULL DEFAULT '',client_type TEXT NOT NULL DEFAULT 'human',bot_score REAL NOT NULL DEFAULT 0,is_new_session INTEGER NOT NULL DEFAULT 1,lcp_ms INTEGER NOT NULL DEFAULT 0,inp_ms INTEGER NOT NULL DEFAULT 0,cls_x100 INTEGER NOT NULL DEFAULT 0,created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP);CREATE INDEX IF NOT EXISTS idx_va_visitor_time ON vayuanalytics_sessions(visitor_hash, entry_time);`
