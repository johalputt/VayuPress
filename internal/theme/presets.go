...
func Midnight() Tokens {
	return Tokens{
		...
		MutedDark: "#72829a", AccentDark: "#818cf8", Accent2Dark: "#c4b5fd", HiDark: "#38bdf8", GreenDark: "#34d399",
		BgLight: "#f0f4ff", SurfaceLight: "#ffffff", TextLight: "#1e1b4b", MutedLight: "#595cf0",
		AccentLight: "#4f46e5", Accent2Light: "#7c3aed", HiLight: "#0d95d2",
...
func Bloom() Tokens {
	return Tokens{
		...
		MutedDark: "#be7395", AccentDark: "#f472b6", Accent2Dark: "#fda4af", HiDark: "#fb923c", GreenDark: "#86efac",
		BgLight: "#fff5f7", SurfaceLight: "#ffffff", TextLight: "#4a1526", MutedLight: "#be185d",
		AccentLight: "#d52473", Accent2Light: "#e11d48", HiLight: "#ed6506",
		FontSans: "Inter, system-ui, sans-serif", FontMono: "IBM Plex Mono, monospace",
...
func Mint() Tokens {
	return Tokens{
		...
		BgLight: "#f0fdf4", SurfaceLight: "#ffffff", TextLight: "#064e3b", MutedLight: "#04835c",
		AccentLight: "#0b835b", Accent2Light: "#047857", HiLight: "#0d9488",
		FontSans: "Inter, system-ui, sans-serif", FontMono: "IBM Plex Mono, monospace",
...
func Solar() Tokens {
	return Tokens{
		...
		AccentLight: "#ad5f05", Accent2Light: "#ea580c", HiLight: "#f16606",
...
func Plum() Tokens {
	return Tokens{
		...
		AccentLight: "#9333ea", Accent2Light: "#6b21a8", HiLight: "#0d97d5",
...
func Fog() Tokens {
	return Tokens{
		...
		BgLight: "#f3f4f6", SurfaceLight: "#ffffff", TextLight: "#1f2937", MutedLight: "#686f7d",
		AccentLight: "#686f7d", Accent2Light: "#4b5563", HiLight: "#3b82f6",
		FontSans: "Inter, system-ui, sans-serif", FontMono: "IBM Plex Mono, monospace",
...
func Amber() Tokens {
	return Tokens{
		...
		AccentLight: "#976703", Accent2Light: "#854d0e", HiLight: "#b28806",
...
func Pine() Tokens {
	return Tokens{
		...
		AccentLight: "#12843c", Accent2Light: "#166534", HiLight: "#b58a06",
		FontSans: "Inter, system-ui, sans-serif", FontMono: "IBM Plex Mono, monospace",
...
func Lavender() Tokens {
	return Tokens{
		...
		AccentLight: "#7e4af5", Accent2Light: "#6d28d9", HiLight: "#ec4899",
		FontSans: "system-ui, Inter, sans-serif", FontMono: "IBM Plex Mono, monospace",
		FontSizeBase: "1.0625rem", LineHeight: "1.7", MaxWidth: "42rem", RadiusSm: "0.5rem", RadiusLg: "0.75rem",
	}
}
...
func Noir() Tokens {
	return Tokens{
		...
		MutedDark: "#797979", AccentDark: "#fafafa", Accent2Dark: "#a3a3a3", HiDark: "#e5e5e5", GreenDark: "#22c55e",
...
func Meadow() Tokens {
	return Tokens{
		...
		BgLight: "#f7fee7", SurfaceLight: "#fcfdf2", TextLight: "#365314", MutedLight: "#4f800a",
		AccentLight: "#53800e", Accent2Light: "#4d7c0f", HiLight: "#c38504",
		FontSans: "system-ui, Inter, sans-serif", FontMono: "IBM Plex Mono, monospace",
...
func Rust() Tokens {
	return Tokens{
		...
		AccentLight: "#c54a0a", Accent2Light: "#9a3412", HiLight: "#ee6506",
		FontSans: "Georgia, Inter, serif", FontMono: "IBM Plex Mono, monospace",
...
func Glacier() Tokens {
	return Tokens{
		...
		BgLight: "#f0f9ff", SurfaceLight: "#ffffff", TextLight: "#0c4a6e", MutedLight: "#0278b4",
		AccentLight: "#0a79ab", Accent2Light: "#0369a1", HiLight: "#059cb6",
		FontSans: "Inter, system-ui, sans-serif", FontMono: "IBM Plex Mono, monospace",
...
func Coral() Tokens {
	return Tokens{
		...
		BgLight: "#fff1f2", SurfaceLight: "#ffffff", TextLight: "#4c0519", MutedLight: "#d91c45",
		AccentLight: "#de0d30", Accent2Light: "#be123c", HiLight: "#ea580c",
		FontSans: "system-ui, Inter, sans-serif", FontMono: "IBM Plex Mono, monospace",
		FontSizeBase: "1.0625rem", LineHeight: "1.7", MaxWidth: "42rem", RadiusSm: "0.5rem", RadiusLg: "0.75rem",
	}
}
...
func Gale() Tokens {
	return Tokens{
		...
		AccentLight: "#946c09", Accent2Light: "#b7882e", HiLight: "#2563eb",
		FontSans: "Inter, system-ui, sans-serif", FontMono: "IBM Plex Mono, monospace",
...
func Dispatch() Tokens {
	return Tokens{
		...
		AccentLight: "#04845c", Accent2Light: "#047857", HiLight: "#b45309",
...
func Vivid() Tokens {
	return Tokens{
		...
		AccentLight: "#b95321", Accent2Light: "#a8431a", HiLight: "#b8860b",
...
func Ripple() Tokens {
	return Tokens{
		...
		AccentLight: "#0c7f8b", Accent2Light: "#0c8f8e", HiLight: "#d97706",
...
func Maverick() Tokens {
	return Tokens{
		...
		BgLight: "#ffffff", SurfaceLight: "#f4f4f5", TextLight: "#0a0a0a", MutedLight: "#6f6f77",
		AccentLight: "#d6006e", Accent2Light: "#a30054", HiLight: "#c68704",
		FontSans: "Inter, system-ui, -apple-system, 'Segoe UI', sans-serif", FontMono: "IBM Plex Mono, ui-monospace, monospace",
...
func Agora() Tokens {
	return Tokens{
		...
		AccentLight: "#5b54e6", Accent2Light: "#4840c4", HiLight: "#0d9bdb",
		FontSans: "Inter, system-ui, -apple-system, 'Segoe UI', sans-serif", FontMono: "IBM Plex Mono, ui-monospace, monospace",
...
func Vayu() Tokens {
	return Tokens{
		...
		AccentLight: "#0b8176", Accent2Light: "#d97706", HiLight: "#0f766e",
