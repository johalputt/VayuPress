...
// Dispatch — a modern newsletter & email-publication theme (a sovereign
// re-imagining of Ghost's "Brief"). Clean neutral canvas, a confident emerald
// accent, modern sans typography, and an email-width reading measure. Ships a
// full component CSS covering every Brief feature: customizable hero, subscribe
// section, "Featured in" logos, story section, inbox-style featured issues,
// reviews slider, latest-issues feed with sidebar (detailed/minimal), topic
// list, newsletters-page cards, membership tiers, archive, web/email post
// formats, footer, and a light/dark switcher.
