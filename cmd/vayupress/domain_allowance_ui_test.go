...
func TestTheOperatorCanSetAMailboxAllowanceFromThePanel(t *testing.T) {
	page := scopedConsolePage(allowanceDomain(t, 5), 0, 0, 2, true, nil, nil, nil, nil)
...
func TestAZeroAllowanceReadsAsNoneNotUnlimited(t *testing.T) {
	page := scopedConsolePage(allowanceDomain(t, 0), 0, 0, 0, true, nil, nil, nil, nil)
...
func TestAFullAllowanceSaysSoBeforeTheRefusal(t *testing.T) {
	page := scopedConsolePage(allowanceDomain(t, 3), 0, 0, 3, true, nil, nil, nil, nil)
...
func TestMailBeingOffIsNotTheSameAsNoAllowance(t *testing.T) {
	page := scopedConsolePage(allowanceDomain(t, 4), 0, 0, 0, false, nil, nil, nil, nil)
