...
STATIC_DIR=./static VAYU_DOCS_DIR=./docs ./vayupress --port 8080`,
    ...
    features: [
      { icon:'🪟', iconBg:'bg-teal-900/60 border border-teal-800/60',   orb:'rgba(45,212,191,0.45)',
        title:'VayuOS — one admin at /os',
        desc:'New in v1.5.0: the three historical admin surfaces — the classic console, Admin v2 and Admin v3 — consolidate into a single, fast admin mounted at /os. All three legacy paths 302-redirect into it (and log a deprecation warning), so there is exactly one place to learn. The block editor gains opt-in AI-assist (continue, rewrite, summarise) with an inline Accept/Discard overlay, plus an inline version-history diff. The Theme Studio is native, legacy posts adopt into blocks losslessly, and a dedicated Governance panel surfaces system mode, error budgets and live policy evaluation. Still a sovereign single binary — zero CDNs, strict CSP with per-request nonces, no unsafe-eval, no unsafe-inline.',
