...
| [ADR-0150](ADR-0150-vayuveil-endpoint-observation-control.md) | VayuVeil: enumerate every observation channel and report only what has been read back from the kernel — never absence as protection | Accepted | Core | 2026-07-29 |
| [ADR-0151](ADR-0151-vayuflow-automation-engine.md) | VayuFlow: automation is a rules engine with declared blast radius, never an agent | Accepted | Core | 2026-07-30 |
...
| [ADR-0136](ADR-0136-premium-ux-motion-and-alpine-csp.md) | Premium UX — Motion/Design Tokens, View Transitions & the Alpine.js CSP Build | Accepted | Core | 2026-07-16 |
...
| [ADR-0117](ADR-0117-vayuos-read-path-resilience.md) | VayuOS Read-Path Resilience — Dedicated Admin DB Lane, Recycled Read Pools, PASSIVE Checkpointing & Off-Request Dashboard Computation | Accepted | Core | 2026-07-08 |
| [ADR-0116](ADR-0116-vayu-theme-and-self-hosted-fonts.md) | Vayu Flagship Theme & Self-Hosted (Sovereign) Web Fonts | Accepted | VayuOS | 2026-07-07 |
