...
STATIC_DIR=./static VAYU_DOCS_DIR=./docs ./vayupress --port 8080`,
    ...
    screenshots: [
      ...
      { label:'Admin dashboard',  path:'/os',               src:'screenshots/admin-v3-dashboard.png', caption:'VayuOS — the single, fast Admin v3. Grouped sidebar, stat cards and a CSP-safe 14-day server-rendered sparkline (ADR-0068).' },
      ...
      { label:'SEO',              path:'/os/seo',           src:'screenshots/admin-v3-seo.png',     caption:'Native SEO — sitemap, robots, structured data and per-post readiness, all in v3.' },
