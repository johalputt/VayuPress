...
STATIC_DIR=./static VAYU_DOCS_DIR=./docs ./vayupress --port 8080`,
    ...
    screenshots: [
      ...
      { label:'VayuOS dashboard', path:'/os',               src:'screenshots/admin-v3-dashboard.png', caption:'VayuOS — the single, fast admin at /os. Grouped sidebar, stat cards and a CSP-safe 14-day server-rendered sparkline (ADR-0068).' },
      { label:'Block editor',     path:'/os/editor',        src:'screenshots/admin-v3-editor.png',  caption:'Typed block editor with opt-in AI-assist and inline version-history diff — document rendered server-side and re-sanitised, no raw-HTML escape hatch.' },
      { label:'Theme Studio',     path:'/os/theme',         src:'screenshots/admin-v3-theme.png',   caption:'Native Theme Studio (v1.5.0) — preset gallery and design-token editor with an instant, CSP-clean live preview via scripted CSSOM. No inline styles, no CDNs.' },
      { label:'Governance',       path:'/os/governance',    src:'screenshots/admin-v3-governance.png', caption:'Governance panel — system mode + transition lineage, error-budget ledger, and live policy-engine evaluation (pass/warn/fail). Server-rendered, CSP-clean.' },
      { label:'Tools & Plugins',  path:'/os/tools',         src:'screenshots/admin-v3-tools.png',   caption:'Tools & Plugins — sovereign built-in modules plus a live registry of sandboxed out-of-process plugins (capability allowlists, seccomp, namespaces). See docs/plugins/SPEC.md.' },
      { label:'Monitoring',       path:'/os/monitoring',    src:'screenshots/admin-v3-monitoring.png', caption:'Monitoring — live latency percentiles, storage/queue health and the governance budget ledger, polled from the same in-process sources as the JSON APIs.' },
      { label:'Media library',    path:'/os/media',         src:'screenshots/admin-v3-media.png',   caption:'Media library — magic-number-validated uploads; SVG refused as an XSS vector.' },
      { label:'SEO',              path:'/os/seo',           src:'screenshots/admin-v3-seo.png',     caption:'Native SEO — sitemap, robots, structured data and per-post readiness, all in VayuOS.' },
      { label:'Analytics',        path:'/os/analytics',     src:'screenshots/admin-v3-analytics.png', caption:'Privacy-first analytics — cookieless, no PII, daily aggregates only.' },
      { label:'Security (2FA)',   path:'/os/security',      src:'screenshots/admin-v3-security.png', caption:'Security — TOTP two-factor enrolment (RFC 6238, pure stdlib), enforced on sign-in.' },
