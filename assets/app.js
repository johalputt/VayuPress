...
STATIC_DIR=./static VAYU_DOCS_DIR=./docs ./vayupress --port 8080`,
    ...
    features: [
      { icon:'✍️', iconBg:'bg-teal-900/60 border border-teal-800/60',   orb:'rgba(45,212,191,0.55)',
        ...
        desc:'A calm, distraction-free block editor with tables, toggles, task lists, math, callouts, code, self-hosted audio and privacy-first video. Drag to reorder, undo anything, and watch live word-count and reading time as you type. A slash menu and a ⌘K palette put every block one keystroke away — and a focus mode and split-screen preview keep you in flow.',
        tags:['block editor','slash menu · ⌘K','focus + live preview'] },
      { icon:'✉️', iconBg:'bg-sky-900/60 border border-sky-800/60',     orb:'rgba(56,189,248,0.5)',
        title:'VayuMail — your own mail server',
        desc:'Send and receive from your own domain without renting a mail provider. Outbound mail is DKIM-signed and delivered straight to the recipient\'s server; an inbound SMTP receiver and IMAP inbox let Thunderbird, K-9 and Apple Mail read your mail. It even writes your MX, SPF, DKIM and DMARC records for you and checks the DNS is healthy.',
        tags:['DKIM-signed','direct delivery','IMAP inbox'] },
      ...
      { icon:'📦', iconBg:'bg-amber-900/60 border border-amber-800/60',   orb:'rgba(245,158,11,0.4)',
        ...
        desc:'Install the latest signed release from inside VayuOS — the download is checksum- and signature-verified, your database is backed up first, and the binary swaps in atomically. Export your whole site as a single checksummed archive and restore it anywhere. No shell required, fully reversible.',
        tags:['signed updates','full backup/restore','reversible'] },
